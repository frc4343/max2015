...
public class OneTwoReverse extends CommandGroup {
    ...
    public  OneTwoReverse() {
        ...
        addSequential(new TurnWithGyro2(0.5, 81, true)); // was 70
        ...
        addSequential(new TurnWithGyro2(0.6, -23, false)); // was true
        addSequential(new DriveIndefinitely(0.8), 1.5);
        addSequential(new DriveIndefinitely(0), 0.5);
        addSequential(new ClawClose());
        addSequential(new DriveIndefinitely(0), 0.5);
        addParallel(new TransmissionAscend(), 1);
        ...
        addSequential(new TurnWithGyro2(0.6, 60, false)); // was true
    }
}
